...
public class Project extends JFrame implements ActionListener {
    ...
    Project(){
        super("Mehran University Management System");
        ...
        ImageIcon icon23 = new ImageIcon(ClassLoader.getSystemResource("icon/icon14.jpg"));
        ...
        ImageIcon icon25 = new ImageIcon(ClassLoader.getSystemResource("icon/icon15.png"));
        ...
        ImageIcon icon27 = new ImageIcon(ClassLoader.getSystemResource("icon/icon15.png"));
        ...
        ImageIcon icon29 = new ImageIcon(ClassLoader.getSystemResource("icon/icon14.jpg"));
        ...
        ImageIcon icon30 = new ImageIcon(ClassLoader.getSystemResource("icon/icon16.png"));
        ...
        ImageIcon icon32 = new ImageIcon(ClassLoader.getSystemResource("icon/icon17.png"));
        ...
        ImageIcon iconn = new ImageIcon(ClassLoader.getSystemResource("icon/icon6.png"));
        ...
        ImageIcon icon14 = new ImageIcon(ClassLoader.getSystemResource("icon/icon7.png"));
        ...
        ImageIcon icon16 = new ImageIcon(ClassLoader.getSystemResource("icon/icon8.png"));
        ...
        ImageIcon icon18 = new ImageIcon(ClassLoader.getSystemResource("icon/icon9.png"));
        ...
        ImageIcon icon20 = new ImageIcon(ClassLoader.getSystemResource("icon/icon10.png"));
...
//        About.setIcon(new ImageIcon(image22));
        About.setMnemonic('L');
